...
namespace CozyWorldGeneration.Editor
{
    ...
    public class GridManagerEditor : UnityEditor.Editor
    {
        ...
        private void CreateGridSettingsSection()
        {
            ...
            var widthField = new IntegerField("Grid Width") { value = serializedObject.FindProperty("gridWidth").intValue };
            ...
            var heightField = new IntegerField("Grid Height") { value = serializedObject.FindProperty("gridHeight").intValue };
            ...
            var tileSizeField = new FloatField("Tile Size") { value = serializedObject.FindProperty("tileSize").floatValue };
        ...
        private void CreateLayerCollectionSection()
        {
            ...
            var worldLayersContainer = CreateCollectionUI("World Layers", gridManager.WorldLayerCollection);
            root.Add(worldLayersContainer);

            // Visual Layers Section
            var visualLayersContainer = CreateCollectionUI("Visual Layers", gridManager.VisualLayerCollection);
            root.Add(visualLayersContainer);
        }

        private VisualElement CreateCollectionUI(string collectionName, LayerCollection collection)
        {
        ...
        private void RefreshLayerList(LayerCollection collection, Foldout parentFoldout)
        {
            ...
            while (parentFoldout.childCount > 1)
            {
                parentFoldout.RemoveAt(1);
            }
        ...
        private VisualElement CreateLayerUI(WorldLayer layer, LayerCollection collection, Foldout parentFoldout)
        {
            ...
            foldout.RegisterValueChangedCallback(evt => 
            {
                layer.foldoutState = evt.newValue;
            });
